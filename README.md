...
- Output naming with datetime suffix `YYYYMMDDHHMM` to avoid overwrite.
...
## Output Files
For datetime `202603101430`, outputs are:
- `input_202603101430.txt` (or `<prefix>_input_202603101430.txt`)
- `blanks_202603101430.txt` (or `<prefix>_blanks_202603101430.txt`)
- `answers_202603101430.txt` (or `<prefix>_answers_202603101430.txt`)

If prefix starts with underscore, it is normalized. Example:
- `--output ioputs/_` -> `ioputs/input_202603101430.txt`, `ioputs/blanks_202603101430.txt`, `ioputs/answers_202603101430.txt`

If output ends with `/`, it is treated as a directory. Example:
- `--output ioputs/` -> `ioputs/input_202603101430.txt`, `ioputs/blanks_202603101430.txt`, `ioputs/answers_202603101430.txt`
